...
<head>
    ...
    <link rel="stylesheet" href="/CODEPFE/src/css/style.css">
    <script type="module" src="/CODEPFE/src/js/script.js"></script>
...
<body>
  <header>
    <nav class="navbar navbar-expand-lg">
      <div class="logo">
        <a href="index.php?route=home"> TORT<span>IKI</span></a>
