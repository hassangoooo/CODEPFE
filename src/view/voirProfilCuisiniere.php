...
<div id="profile-container">
    ...
    <img src="<?= htmlspecialchars($cuisiniere['image_de_cuisinieres']); ?>" alt="Photo de profil" style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%;">
</div>

<div id="plats-container">
    <h3>Plats proposés par <?= htmlspecialchars($cuisiniere['nom_cuisinieres']); ?></h3>
    <div id="plats-cuisiniere">
...
<script>
    ...
    function afficherPlatsPublies(data) {
        const platsContainer = document.getElementById("plats-cuisiniere");
    ...
    const divPanier = document.createElement("div"); // Déclarez et initialisez divPanier ici
