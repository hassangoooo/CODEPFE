...
<section class="htc__contact__area ptb--100 bg__white" >
        ...
        <div class="row">
              ...
              <br>
							<div class="col-xs-12">
                            <form id="login-form" method="post" action="index.php?route=loginCuisiniere">
        ...
        <button type="submit" class="fv-btn">Connexion</button>
					...
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
							<form id="register-form" method="post" action="index.php?route=registerCuisinieres" enctype="multipart/form-data">
    <br>
    <div class="single-contact-form">
        <div class="contact-box name">
    ...
    <div class="single-contact-form">
        <div class="contact-box name">
            <input type="text" id="prenom" name="prenom" placeholder="Votre prenom*" style="width:100%" required>
        </div>
    ...
    <div class="single-contact-form">
        <div class="contact-box name">
            <input type="text" id="telephone" name="telephone" placeholder="Votre Telephone*" style="width:100%" required>    
        </div>
    ...
    <div class="single-contact-form">
        <div class="contact-box name">
            <input type="text" id="departement" name="num_departement" placeholder="Votre num_departement*" style="width:100%" required>
        </div>
    ...
    <div class="single-contact-form">
        <div class="contact-box name">
            <input type="text" id="description" name="description" placeholder=" description*" style="width:100%" required>
        </div>
        <span class="field_error" id="confirm_ville_error"></span>
    </div>
    <br>
